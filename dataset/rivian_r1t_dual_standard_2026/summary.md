# 2026 Rivian R1T Dual Standard Summary

- Dataset ID: 101
- Slug: `rivian_r1t_dual_standard_2026`
- Market: US
- Spec asset: `specs.md` generated from official manufacturer sources
- Finance asset: `finance.md` generated from live official Rivian pricing pages where available
- Image asset: `images/front.jpg`
- MSRP snapshot: Rivian R1T page shows: From $72,990.
...
- Drivetrain: AWD
- Fuel type: electric
- Vehicle summary: Entry-level current R1T configuration on Rivian's live U.S. truck page.
- Vehicle summary: Best fit for buyers who want Rivian's pickup format at the lowest current advertised R1T entry point.
