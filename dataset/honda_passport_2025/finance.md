# 2025 Honda Passport Finance Snapshot

- Market: Canada
- MSRP: Honda Canada builder selling price shown: $60,136
- Total before tax: Honda Canada Build & Price shows $60,136 before tax, with freight, PDI, levies, and dealer fees included in the displayed selling price.
...
- Incentives: Passport pricing is live in Honda Canada's builder, but exact finance and lease quotes need the province-specific calculator.
...
- Best for: Buyers who want a two-row Honda SUV with more outdoor-oriented positioning than CR-V.
- Financial strengths: Builder pricing is fee-inclusive and easier to compare than a bare MSRP.
- Financial concerns: The original research set used a 2025 Passport PDF, but the active Honda Canada retail flow is 2026 Passport.
- Notes: Snapshot uses Honda Canada's active builder data on March 25, 2026. The current consumer flow for this nameplate is 2026 Passport.
- Snapshot date: March 25, 2026
- Sources:
  - https://www.honda.ca/en/buildyourhonda/trims?model_key=passport&model_year=2026&payment_frequency=weekly&payment_method=lease&term_and_rate=60&trade_in_value=0&trade_in_owing=0&down_payment=0
